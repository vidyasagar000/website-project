          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>Radiant</span>Technologies</h1>
                  <h2>Home Care products @ your finger Tip</h2>
                  <p>Home life made easy</p>
              ...
              <div class="item">
                <div class="col-sm-6">
                 <h1><span>Radiant</span>Technologies</h1>
                  <h2>Home Care products @ your finger Tip</h2>
                  <p>Add Touch ups to your Home</p>
